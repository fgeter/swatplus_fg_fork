...
!!     and reservoirs.
!!
!!     object.cnt is opened by filename alone.  If -i was given, main has
!!     already chdir()'d to the input directory.  getcwd() is reported on
!!     a missing file so a wrong -i path is diagnosable.
